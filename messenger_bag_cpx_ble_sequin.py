...
#===| User Config |==================================================
SNOWGLOBE_NAME = "Regis" # name that will show up on smart device
DEFAULT_ANIMATION = 1        # 0-3, index in ANIMATIONS list
DEFAULT_DURATION = 5         # total seconds to play animation
DEFAULT_SPEED = 0.1          # delay in seconds between updates
DEFAULT_COLOR = 0x980992     # hex color value
DEFAULT_SHAKE = 1           # lower number is more sensitive
